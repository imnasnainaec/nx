...
Let’s give a fast overview of the main configuration files. All the details can be found on the official docs page: [/reference/project-configuration](/reference/project-configuration)
